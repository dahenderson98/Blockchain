...
public class Main {
    ...
    public static void main(String[] args) throws NoSuchProviderException, NoSuchAlgorithmException, InvalidKeyException, SignatureException {
        ...
        /*
         * Create new block6 chained to block4 with tx alice -> bob
         */
        Block block6 = new Block(block4.getHash(), pk_alice.getPublic());
        //block6.finalize();
        boolean blockProcessed = bh.processBlock(block6);
        System.out.println("Block6 Added ok: " + blockProcessed);
